...
def run_hc(ivecs_names, ivecs, data_dirs, label, prange, out_fig, style_list=None):
    purity_list=[]
    for ivec_scp, datadir in zip(ivecs, data_dirs):                                                                                                                                 
        ...
        plot_purity(purity_list, out_fig, ivecs_names, label, style_list=style_list)                                                                                                
...
if __name__ == '__main__' :
    ...
    ivecs=['exp_emime/ivectors-deltassdc/ivectors_128_tr-train_{}_ts-train_{}/ivector.scp'.format(n, n) for n in ivecs_names]
    data_dirs=['data/emime/train_{}'.format(n) for n in ivecs_names]
    style_list=[('mediumseagreen', '--'), ('forestgreen', '--'), ('r', '--'), ('b', '--'), ('r','-.'), ('b', '-.'), ('r',':'), ('b', ':')]
    label='spk'
    ...
    for lang in ['fin', 'ger']:
        for t_type in ['bil', 'mixed']:
            ...
            style_list=[('mediumseagreen','--'), ('forestgreen', '--'), ('lime', '--'),('r', '-.'), ('r',':')]
            label='lang'
